...
function NewRenovation({userId, createRenovation}) {
    ...
    return <>
        ...
        <Row>
            <Col>
                <Card>
                    <Card.Img style={{ height: '24rem' }} variant="top" src="https://www.designideasguide.com/wp-content/uploads/2019/04/Apartment-Video-Game-Living-Room-Ideas.jpg" />
            ...
            <Col>
                <Card>
                    <Card.Img style={{ height: '24rem' }} variant="top" src="https://i.imgur.com/YgTPeZA.jpeg" />
                    <Card.Body className='text-center'>
            ...
            <Col>
                <Card>
                    <Card.Img style={{ height: '24rem' }} variant="top" src="https://www.pcgamesn.com/wp-content/uploads/2021/08/How_to_build_the_best_streaming_setup_Elgato.jpg" />
                    <Card.Body className='text-center'>
